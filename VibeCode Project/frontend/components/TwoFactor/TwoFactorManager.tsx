...
export default function TwoFactorManager({ onUpdate }: TwoFactorManagerProps) {
  ...
  const loadTelegramBotInfo = async () => {
    try {
      ...
      // Telegram bot info is optional, don't show error
        ...
        <div className="space-y-4">
          ...
          <div className="flex space-x-3">
            <button
              ...
              className="flex-1 px-4 py-2 border border-gray-300 dark:border-white/20 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-50 dark:hover:bg-white/10 transition-colors duration-200 font-medium"
            >
              {showMethods ? 'Hide' : 'Change'} Method
            </button>
            <button
              onClick={handleDisable}
              disabled={actionLoading}
              className="flex-1 px-4 py-2 bg-red-600 hover:bg-red-700 disabled:bg-red-400 text-white rounded-lg transition-colors duration-200 font-medium"
            >
          ...
          {showMethods && (
            <div className="mt-4 p-4 bg-gray-50 dark:bg-gray-800/50 rounded-lg border border-gray-200 dark:border-white/20">
              <p className="text-gray-600 dark:text-gray-300 text-sm mb-4">
                Select a different 2FA method. Your current method will be disabled first.
              </p>
              <div className="space-y-3">
                <button
                  onClick={() => handleEnableMethod('email')}
                  disabled={actionLoading || status.method === 'email'}
                  className="w-full flex items-center justify-between p-3 border border-gray-200 dark:border-white/20 rounded-lg hover:border-blue-300 dark:hover:border-blue-400 transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  <div className="flex items-center space-x-3">
                ...
                <button
                  ...
                  disabled={actionLoading || status.method === 'telegram'}
                  className="w-full flex items-center justify-between p-3 border border-gray-200 dark:border-white/20 rounded-lg hover:border-cyan-300 dark:hover:border-cyan-400 transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  <div className="flex items-center space-x-3">
                ...
                <button
                  ...
                  disabled={actionLoading || status.method === 'totp'}
                  className="w-full flex items-center justify-between p-3 border border-gray-200 dark:border-white/20 rounded-lg hover:border-green-300 dark:hover:border-green-400 transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="text-left">
                      <h4 className="font-medium text-gray-900 dark:text-white">Google Authenticator</h4>
                      <p className="text-sm text-gray-600 dark:text-gray-300">Use authenticator app</p>
                    </div>
                  </div>
                  {status.method === 'totp' ? (
                    <span className="text-green-600 text-sm font-medium">Current</span>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            <button
              onClick={() => handleEnableMethod('email')}
              disabled={actionLoading}
              className="w-full flex items-center justify-between p-4 border border-gray-200 dark:border-white/20 rounded-lg hover:border-blue-300 dark:hover:border-blue-400 transition-all duration-200 hover:shadow-md group"
            >
              <div className="flex items-center space-x-3">
                <div className="w-10 h-10 bg-blue-100 dark:bg-blue-900/20 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-200">
            ...
            <button
              onClick={() => handleEnableMethod('telegram')}
              disabled={actionLoading}
              className="w-full flex items-center justify-between p-4 border border-gray-200 dark:border-white/20 rounded-lg hover:border-cyan-300 dark:hover:border-cyan-400 transition-all duration-200 hover:shadow-md group"
            >
              <div className="flex items-center space-x-3">
                <div className="w-10 h-10 bg-cyan-100 dark:bg-cyan-900/20 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-200">
              ...
              <span className="text-gray-400 group-hover:text-cyan-500 transition-colors duration-200">→</span>
            </button>

            <button
              onClick={() => handleEnableMethod('totp')}
              disabled={actionLoading}
              className="w-full flex items-center justify-between p-4 border border-gray-200 dark:border-white/20 rounded-lg hover:border-green-300 dark:hover:border-green-400 transition-all duration-200 hover:shadow-md group"
            >
              <div className="flex items-center space-x-3">
                <div className="w-10 h-10 bg-green-100 dark:bg-green-900/20 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-200">
              ...
              <span className="text-gray-400 group-hover:text-green-500 transition-colors duration-200">→</span>
            </button>
          </div>
        </div>
      )}
